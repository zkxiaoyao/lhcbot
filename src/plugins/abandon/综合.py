...
#     else:
#         await wettr.send(f'{city}tql!比祝博洋强多了！')


# w = on_fullmatch('赛博网关8080')
...
#     try:
#         if t - lt > 10:
#             await w.send(random.choices(['启动！祝博洋快来玩！', '原神？'], [0.8, 0.2])[0])
#         else:
...
# @pp.got("city", prompt="你要测试和谁的匹配程度呢？注意：不能和祝博洋匹配，否则你会后悔的")
